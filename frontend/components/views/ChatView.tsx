      ...
      <div className="border-t border-outline px-4 py-3">
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-primary text-white shadow-soft-blue transition-airy hover:bg-primary-dark disabled:bg-outline disabled:text-foreground-muted"
          >
