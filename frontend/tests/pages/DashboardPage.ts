...
export class DashboardPage {
  ...
  constructor(page: Page) {
    ...
    this.inventoryTab = page.locator("button:has-text('คลังอาหาร')").first();
    this.scannerTab = page.locator("button:has-text('สแกน')").first();
    this.recipeTab = page.locator("button:has-text('สูตรอาหาร')").first();
    this.chatTab = page.locator("button:has-text('แชท AI')").first();
    ...
    this.openManualFormBtn = page.locator("button:has-text('เพิ่มวัตถุดิบด้วยมือ')").first();
